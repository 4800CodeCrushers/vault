...
def beforeRequest():
	...
	if request.path != '/'  and request.path != '/manifest.json' and request.path != '/favicon.ico' and not request.path.startswith('/static/') and request.path != '/api/auth/login' and request.path != '/api/auth/create':
